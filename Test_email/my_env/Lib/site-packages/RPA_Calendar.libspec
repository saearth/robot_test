...
<keywordspec name="RPA.Calendar" type="LIBRARY" format="REST" scope="GLOBAL" generated="2024-09-17T13:59:04+00:00" specversion="5" source="./RPA/Calendar.py" lineno="24">
<version/>
...
<kw name="Compare Times" lineno="862">
...
<kw name="Compare Times ${time1} &lt; ${time2}" lineno="820">
<arguments repr="">
</arguments>
<doc>Compares given times and returns `True` if `time2`
is more recent than `time1`.
...
<kw name="Compare Times ${time1} &gt; ${time2}" lineno="841">
<arguments repr="">
</arguments>
...
<kw name="Create Time" lineno="240">
...
<kw name="First Business Day Of The Month" lineno="671">
...
<kw name="Get Iso Calendar" lineno="892">
...
<kw name="Is the ${date} Business Day in ${country}" lineno="973">
<arguments repr="">
</arguments>
...
<kw name="Is the ${date} Holiday in ${country}" lineno="1032">
<arguments repr="">
</arguments>
...
<kw name="Is The Date Business Day" lineno="923">
<arguments repr="date: str | date | DateTime, country: str | None = None">
<arg kind="POSITIONAL_OR_NAMED" required="true" repr="date: str | date | DateTime">
<name>date</name>
<type name="Union" union="true">str | date | DateTime<type name="str" typedoc="string">str</type><type name="date" typedoc="date">date</type><type name="DateTime" typedoc="datetime">DateTime</type></type>
...
<kw name="Is The Date Holiday" lineno="994">
<arguments repr="date: str | date | DateTime, country: str | None = None">
<arg kind="POSITIONAL_OR_NAMED" required="true" repr="date: str | date | DateTime">
<name>date</name>
<type name="Union" union="true">str | date | DateTime<type name="str" typedoc="string">str</type><type name="date" typedoc="date">date</type><type name="DateTime" typedoc="datetime">DateTime</type></type>
...
<kw name="Last Business Day Of The Month" lineno="715">
<arguments repr="date: str | date | DateTime, country: str | None = None">
<arg kind="POSITIONAL_OR_NAMED" required="true" repr="date: str | date | DateTime">
<name>date</name>
<type name="Union" union="true">str | date | DateTime<type name="str" typedoc="string">str</type><type name="date" typedoc="date">date</type><type name="DateTime" typedoc="datetime">DateTime</type></type>
...
<kw name="Return Holidays" lineno="632">
...
<kw name="Return Next Business Day" lineno="568">
...
<kw name="Return Previous Business Day" lineno="535">
<arguments repr="date: str | date | DateTime, country: str | None = None, return_format: str = YYYY-MM-DD, locale: str | None = None">
<arg kind="POSITIONAL_OR_NAMED" required="true" repr="date: str | date | DateTime">
<name>date</name>
<type name="Union" union="true">str | date | DateTime<type name="str" typedoc="string">str</type><type name="date" typedoc="date">date</type><type name="DateTime" typedoc="datetime">DateTime</type></type>
...
<kw name="Sort List Of Dates" lineno="768">
...
<kw name="Time Difference Between Timezones" lineno="499">
...
<kw name="Time Difference In Days" lineno="374">
<arguments repr="start_date: str | date | DateTime, end_date: str | date | DateTime, start_timezone: str | None = None, end_timezone: str | None = None">
<arg kind="POSITIONAL_OR_NAMED" required="true" repr="start_date: str | date | DateTime">
<name>start_date</name>
<type name="Union" union="true">str | date | DateTime<type name="str" typedoc="string">str</type><type name="date" typedoc="date">date</type><type name="DateTime" typedoc="datetime">DateTime</type></type>
...
<kw name="Time Difference In Hours" lineno="416">
<arguments repr="start_date: str | date | DateTime, end_date: str | date | DateTime, start_timezone: str | None = None, end_timezone: str | None = None">
<arg kind="POSITIONAL_OR_NAMED" required="true" repr="start_date: str | date | DateTime">
<name>start_date</name>
<type name="Union" union="true">str | date | DateTime<type name="str" typedoc="string">str</type><type name="date" typedoc="date">date</type><type name="DateTime" typedoc="datetime">DateTime</type></type>
...
<kw name="Time Difference In Minutes" lineno="458">
<arguments repr="start_date: str | date | DateTime, end_date: str | date | DateTime, start_timezone: str | None = None, end_timezone: str | None = None">
<arg kind="POSITIONAL_OR_NAMED" required="true" repr="start_date: str | date | DateTime">
<name>start_date</name>
<type name="Union" union="true">str | date | DateTime<type name="str" typedoc="string">str</type><type name="date" typedoc="date">date</type><type name="DateTime" typedoc="datetime">DateTime</type></type>
...
<kw name="Time Difference In Months" lineno="332">
<arguments repr="start_date: str | date | DateTime, end_date: str | date | DateTime, start_timezone: str | None = None, end_timezone: str | None = None">
<arg kind="POSITIONAL_OR_NAMED" required="true" repr="start_date: str | date | DateTime">
<name>start_date</name>
<type name="Union" union="true">str | date | DateTime<type name="str" typedoc="string">str</type><type name="date" typedoc="date">date</type><type name="DateTime" typedoc="datetime">DateTime</type></type>
