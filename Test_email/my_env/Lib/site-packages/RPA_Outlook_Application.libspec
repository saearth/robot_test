...
<keywordspec name="RPA.Outlook.Application" type="LIBRARY" format="REST" scope="GLOBAL" generated="2024-09-17T13:59:07+00:00" specversion="5" source="./RPA/Outlook/Application.py" lineno="18">
<version/>
...
<arguments repr="recipients: str | List[str], subject: str, body: str, html_body: bool = False, attachments: List[str] | str | None = None, save_as_draft: bool = False, cc_recipients: List[str] | str | None = None, bcc_recipients: List[str] | str | None = None, reply_to: List[str] | str | None = None, check_names: bool = False">
...
<arg kind="POSITIONAL_OR_NAMED" required="false" repr="reply_to: List[str] | str | None = None">
<name>reply_to</name>
<type name="Union" union="true">List[str] | str | None<type name="List" typedoc="list">List[str]<type name="str" typedoc="string">str</type></type><type name="str" typedoc="string">str</type><type name="None" typedoc="None">None</type></type>
<default>None</default>
</arg>
